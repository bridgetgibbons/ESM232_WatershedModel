...
unique(temp_codes$parameter_units) #what are the units?
...
vallecito_snotel <- grabNRCS.data(network = "SNTL", 
                            site_id = 843, 
                            timescale = "daily", 
...
#runnign sum of SWE
#running sum of temp
#running sum of calculated "melt" from melt submodel 


#USGS Stream & Temp: VALLECITO CREEK NEAR BAYFIELD, CO. 


#get ambient air and water temp data from LOS PINOS RIVER AT LA BOCA, CO. 
#stream cfs if there 

#swe from 843
#amient air from VALLECITO CREEK NEAR BAYFIELD, CO. 

usgs_stream_temp <- readNWISdata(siteNumbers = "09352900",
                     parameterCd = "00010",
                     startDate = "1990-10-01",
                     endDate = "2020-09-30") %>% 
  renameNWISColumns()

usgs_stream_dis <- readNWISdata(siteNumbers = "09352900",
                     parameterCd = "00060",
                     startDate = "1990-10-01",
                     endDate = "2020-09-30") %>% 
  renameNWISColumns() 

usgs_air_temp <- readNWISdata(siteNumbers = "09352900",
                     parameterCd = "00020",
                     startDate = "1990-10-01",
                     endDate = "2020-09-30") %>% 
  renameNWISColumns()
