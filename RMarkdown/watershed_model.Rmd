...
model_y = LHS(NULL, factors, nsets, q, q.arg)
LHS_pars = get.data(model_y)
...
y = pse::tell(model_y, t(LHS_results))
...
bathtub_df <- as.data.frame(outflow(input_df = melt_df, storage_initial = 70555, k = 0.05, evap = 22.66, outflow_only = TRUE))
